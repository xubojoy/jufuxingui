         ...
         [req getRegistWithNSDictionary:postDict andSuccessBlock:^(id data) {
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if ([[dic objectForKey:@"code"] isEqualToString:@"01"]) {
                    tim=0;
                    [weeksafa ontime];
                    weeksafa.user.token=[dic objectForKey:@"token"];
                    ...
                    weeksafa.user.truename=[[dic objectForKey:@"result"] objectForKey:@"realname"];
                    weeksafa.user.pwd=weeksafa.pwdtext.myTextField.text;
                    //weeksafa.user.token=[[dic objectForKey:@"result"] objectForKey:@"token"];
                    ...
                    weeksafa.user.userid=[[dic objectForKey:@"result"] objectForKey:@"id"];
                }else{
                    NSLog(@"%@",dic);
