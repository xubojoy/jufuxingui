...
-(void)getadata:(int)page{
    ...
    [request getjihuaDataWithpage:page end:pagenum token:self.user.token SuccessBlock:^(id data) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        UILabel * linlabel=[[UILabel alloc]initWithFrame:CGRectMake(0,59,Screen_weight,1)];
