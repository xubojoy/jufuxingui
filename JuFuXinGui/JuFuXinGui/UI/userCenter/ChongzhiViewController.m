...
- (void)initbody{
    ...
    UILabel * namelabel=[[UILabel alloc]initWithFrame:CGRectMake(15,5,160, 40)];
    namelabel.text=@"用户可用金额";
   ...
   //[view addSubview:pwdlabel1];
    self.cashfield=[[UITextField alloc]initWithFrame:CGRectMake(Screen_weight-60,5,150, 40)];
    self.cashfield.keyboardType=UIKeyboardTypeNumberPad;
    self.cashfield.placeholder=[NSString stringWithFormat:@"¥%@",self.user.money];
    self.cashfield.userInteractionEnabled=NO;
    ...
    self.rcachfield.keyboardType=UIKeyboardTypeNumberPad;

    self.rcachfield.placeholder=@"¥100";
    [view addSubview:self.rcachfield];
    self.rcachfield.delegate=self;
    self.rcachfield.inputAccessoryView=toolbar;
    self.rcachfield.userInteractionEnabled=YES;
