...
//#define kCircleMargin 30.0              // 圆点离屏幕左边距 32.0
//#define kCircleDiameter 68.0            // 圆点直径 68.0
...
//#define kLLLineColor [UIColor colorWithRed:18/255.0 green:140/255.0 blue:224/255.0 alpha:0.8] // 线条色蓝
...
//        int y = (kCircleMargin + (i/3) * (kCircleDiameter+(320-kCircleMargin*2- kCircleDiameter *3)/2))-34;
...
//        [button setBackgroundImage:[UIImage imageNamed:@"circle4"] forState:UIControlStateNormal];
//       // [button setBackgroundImage:[UIImage imageNamed:@"circle_selected"] forState:UIControlStateSelected];
//        [button setBackgroundImage:[UIImage imageNamed:@"正确"] forState:UIControlStateSelected];
...
//             [button setBackgroundImage:[UIImage imageNamed:@"错误"] forState:UIControlStateSelected];
//        }
//        
//    }
//    
...
- (void)initCircles
{
    ...
    for (int i = 0; i < 9; i++) {
        ...
        if (Screen_height==480) {
            y=(kCircleMargin + (i/3) * (kCircleDiameter+(320-kCircleMargin*2- kCircleDiameter *3)/2))-34;
        }
        //LLLog(@"每个圆点位置 %d,%d", x, y);
        [button setFrame:CGRectMake(x, y, kCircleDiameter, kCircleDiameter)];
