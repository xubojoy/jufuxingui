...
//     [MBHUDView hudWithBody:@"正在加载..." type:MBAlertViewHUDTypeActivityIndicator hidesAfter:30 show:YES];
    NSString *url = URL_all_tou_zi(self.pageNo,10);
...
//初始化tableView
-(void)initTableView{
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.header.frame.size.height, screen_width, VIEW_HEIGHT-49-self.header.frame.size.height) style:UITableViewStylePlain];
