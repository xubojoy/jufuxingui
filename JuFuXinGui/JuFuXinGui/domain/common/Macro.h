...
///index.php?g=home&m=credinfo&a=active_list

#define URL_Index_huodong [MAINURL stringByAppendingString:[NSString stringWithFormat:@"g=home&m=credinfo&a=active_list"]]

///index.php?g=home&m=credinfo&a=active_detail
//INCLUDEPICTURE \d "C:\\Users\\xia\\Documents\\Tencent Files\\27330385\\Image\\C2C\\Y63H6{56PY3`7E4YPYDV`NM.jpg" \* MERGEFORMATINET
#define URL_huodong_detail(id) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"g=home&m=credinfo&a=active_detail&id=%@",id]]


#define URL_Index [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=isrem"]]
//m=Product&a=index
#define URL_all_tou_zi(start,eve) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=index&start=%d&eve=%d",start,eve]]
//m=Product&a=search&month=6&keyword=3&page=1

#define URL_Search(keyword,start,eve) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=search&keyword=%@&start=%d&eve=%d",keyword,start,eve]]
...
#define URL_Product_Detail_info(productId) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=detailt&id=%@",productId]]

#define URL_Product_Details_info(productId) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=detailts&id=%@",productId]]
#define URL_Product_Detailss_info(productId) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=detailtss&id=%@",productId]]
//m=Product&a=allinvest&id=9
#define URL_Product_allinvest_info(productId) [MAINURL stringByAppendingString:[NSString stringWithFormat:@"m=Product&a=allinvest&id=%@",productId]]
